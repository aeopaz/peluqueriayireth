        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="color: black;">Detalle Turno</h5>
                ...
                <div class="modal-body" style="color: black;">
                    @if (isset($detalle_turno[0]))
                        ...
                        <br>
                        Si no se encuentra al momento de ser llamado, su turno será cerrado y tendrá que generar uno
                        nuevo
                </div>
                @endif
